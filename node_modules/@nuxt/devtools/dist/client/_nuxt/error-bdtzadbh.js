import{f as E,q as x}from"#entry";import{_ as N}from"./stacktrace-list.vue-gtf32k2z.js";import{p as y,q as v,J as l,a0 as i,Y as C,a1 as f,a2 as _,W as w,ac as S,a9 as p,V as $}from"./vendor/json-editor-vue-linwxbdb.js";import"./vendor/shiki-hpfujfi3.js";import"./vendor/unocss-c1ookmgn.js";import"./filepath-item.vue-neqjm2ct.js";const O=/(^|@)\S+:\d+/,h=/^\s*at .*(\S+:\d+|\(native\))/m,R=/^(eval@)?(\[native code\])?$/;function F(e,a){if(typeof e.stacktrace<"u"||typeof e["opera#sourceloc"]<"u")return T(e);if(e.stack&&e.stack.match(h))return I(e);if(e.stack)return b(e);throw new Error("Cannot parse given Error object")}function m(e){if(!e.includes(":"))return[e,void 0,void 0];const o=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(e.replace(/[()]/g,""));return[o[1],o[2]||void 0,o[3]||void 0]}function d(e,a){return e}function I(e,a){return V(e.stack)}function V(e,a){return d(e.split(`
`).filter(t=>!!t.match(h))).map(t=>{t.includes("(eval ")&&(t=t.replace(/eval code/g,"eval").replace(/(\(eval at [^()]*)|(,.*$)/g,""));let r=t.replace(/^\s+/,"").replace(/\(eval code/g,"(").replace(/^.*?\s+/,"");const n=r.match(/ (\(.+\)$)/);r=n?r.replace(n[0],""):r;const c=m(n?n[1]:r),s=n&&r||void 0,u=["eval","<anonymous>"].includes(c[0])?void 0:c[0];return{function:s,file:u,line:c[1]?+c[1]:void 0,col:c[2]?+c[2]:void 0,raw:t}})}function b(e,a){return A(e.stack)}function A(e,a){return d(e.split(`
